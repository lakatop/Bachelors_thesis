...
\overfullrule=0mm{Celková štruktúra Report Descriptoru je opísaná v HID Class Specifica\-tion~\cite{report_desc}}. Descriptor sa skladá z tzv. itemov, ktoré obsahujú informácie o danom zariadení. Každý item obsahuje hlavičku, ktorá sa skladá z troch častí:
\begin{itemize}
\item Typ
\item Tag
\item Veľkosť
...
\section{Spracovávanie live capture}
