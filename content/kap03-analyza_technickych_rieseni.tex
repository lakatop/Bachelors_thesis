...
\item Aplikácia pomocou \textit{HID API}~\cite{hid_api} metód \texttt{HidD\_Xxx} získa \textit{Preparsed Data} a informácie ohľadom HID zariadenia.
...
\item Aplikácia pomocou \textit{HID API}~\cite{hid_api} metód \texttt{HidP\_Xxx} interpretuje HID reporty.
\end{enumerate}
